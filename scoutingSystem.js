...
function parseSpeed(pickup, deliver){
	...
	console.log("speed" + distance/150);
	if(climbCount==0){
		return distance/150;
...
function blockCount(array, place){
	var num = 0;
...
function ajaxSubmit(){
    ...
    data: {
      ...
      "deliveredBlockSwitch" : blockCount(deliveredBlockArray, "Switch"), //function for count
	  "deliveredBlockScale" : blockCount(deliveredBlockArray, "Scale"), //function for count
	  "deliveredBlockVault" : blockCount(deliveredBlockArray, "Station"), //function for count
